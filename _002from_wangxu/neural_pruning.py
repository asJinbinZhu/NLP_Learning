...
print('Test Loss of unprune: {:.6f}, Acc: {:.6f}'.format(eval_loss / (len(
...
for data in test_loader:
    ...
    num_correct = (pred == label1).sum()
    eval_acc += num_correct.data[0]
print('Test Loss of prune: {:.6f}, Acc: {:.6f}'.format(eval_loss / (len(
    test_dataset)), eval_acc / (len(test_dataset))))
print('################################################################')
print('################################################################')
print('################################################################')
torch.save(model.state_dict(), 'data_prune/mlp_pruned.pkl')
