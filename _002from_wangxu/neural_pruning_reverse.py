...
print('reverse Test Loss of unprune: {:.6f}, Acc: {:.6f}'.format(eval_loss / (len(
...
f = open('data_prune/sorted_record_big_to_small.txt','r')
...
for data in test_loader:
    ...
    num_correct = (pred == label1).sum()
    eval_acc += num_correct.data[0]
print('reverse Test Loss of prune: {:.6f}, Acc: {:.6f}'.format(eval_loss / (len(
    test_dataset)), eval_acc / (len(test_dataset))))
print('################################################################')
print('################################################################')
print('################################################################')
